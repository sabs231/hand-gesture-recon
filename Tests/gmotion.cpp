...
void  update_mhi( IplImage* img, IplImage* dst, int diff_threshold )
{
    ...
    printf("C I C L O: \n");
    //cvShowImage("Diferencia absoluta",buf[idx2]);
 ...
 //--CAMBIOS--
        ...
        cvExtractSURF( silh, 0, &imageKeypoints, &imageDescriptors, storage2, params );
...
//cvShowImage("Diferencia absoluta",silh);
